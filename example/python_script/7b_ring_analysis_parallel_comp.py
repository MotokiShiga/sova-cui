...
def main ():
    ...
    print("The number of cpu cores in this system: ", cores)
    print("With option num_parallel=-1, ", cores-2, "cpu cores are used.")

    rings = ring_analyzer.calculate(ring_type=RINGs.RingType.PRIMITIVE, num_parallel=-1, )
