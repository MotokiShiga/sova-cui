...
static struct PyModuleDef calculate_domain_centers_def = {
    PyModuleDef_HEAD_INIT,
    "calculate_domain_centers",
    "Python3 C API Module",
    -1,
    calculate_domain_centersMethods
};

PyMODINIT_FUNC PyInit_calculate_domain_centers(void)
{
    return PyModule_Create(&calculate_domain_centers_def);
}
