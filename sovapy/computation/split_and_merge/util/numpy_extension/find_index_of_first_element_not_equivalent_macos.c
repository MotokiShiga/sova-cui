...
static struct PyModuleDef find_index_of_first_element_not_equivalent_def = {
    PyModuleDef_HEAD_INIT,
    "find_index_of_first_element_not_equivalent",
    "Python3 C API Module",
    -1,
    find_index_of_first_element_not_equivalentMethods
};

PyMODINIT_FUNC PyInit_find_index_of_first_element_not_equivalent(void)
{
    return PyModule_Create(&find_index_of_first_element_not_equivalent_def);
}
